	...
	<div class="col-md-6">
        ...
        <form method="post" action="responsibility_insert.php">
            <div class ="form-group">
                <input type="text" class="form-control search_text" placeholder="responsibility code" name ="code" id="resp_cd" required>
        </div>
        <div class ="form-group">
           <input type="text" placeholder=" description" class="form-control search_text" name="description" id="resp_desc" required>
        </div>
        <div class ="form-group">
